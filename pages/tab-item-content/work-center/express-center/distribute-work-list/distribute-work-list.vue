<template>
	<view>
		<view v-if="distributeWorkList && assignType=='distribute-order'" class="distribute-work-container borderTop">
		...
		<image src="../../../../../static/icon/add.png" v-if="assignType=='distribute-order'"
