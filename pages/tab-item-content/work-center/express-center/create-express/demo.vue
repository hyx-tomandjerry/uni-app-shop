			...
			<view class="user-info border-top">
				<view class="flex justify-start position_relative send-info borderBottom align-center">
					...
					<view class="font-size-normal font-weight-normal shopInfo" >
						<text>请填写/添加寄件人信息</text>
					</view>
					<text class=" position_absolute " @click="chooseSender('send')" style="right:21px;top:35px;color:#42B0ED">选择</text>
				</view>
				<view class="flex justify-start position_relative send-info borderBottom align-center">
					...
					<text class=" position_absolute  "  @click="chooseSender('receive')" style="right:21px;top:35px;color:#42B0ED">选择</text>
				</view>
			</view>
		</view>
