	...
	<view>
		<view  style="margin-bottom:13px;">
			<view class="text-gray text-sm">
				...
				<view class="cu-form-group" style="padding-top:10px;">
					<text class="font-size-normal font-weight-normal color-normal" style="margin-right:10px;">上传图片:</text>
				...
				<view class="cu-form-group position_relative" style="border-top:none;">
					<view class="font-size-normal font-weight-normal color-normal " ><text class="text-red" style="margin-right:4rpx;">*</text>品牌类别</view>
					<view @click="showShopCatalog()">
						<text :class="category.name?'text-black':'color-normal'" class="font-size-normal"
							style="margin-right:20px;"
						>{{category.name}}</text>
						<text class="cuIcon-right color-normal  position_absolute" style="font-size:20px;right:17px;bottom:10px;"></text>
					</view>
				</view>
				<view class="cu-form-group">
						<view class="font-size-normal font-weight-normal color-normal"><text style="color:red;margin-right:5px;">*</text>门店名称</view>
						<input type="text" style="width:60%;" placeholder="请输入门店名称" v-model="shop.name"  :class="shop.name ? 'text-black':'color-normal'" class="font-size-normal text-right">
				</view>



				<view class="cu-form-group ">
						<view class="font-size-normal font-weight-normal color-normal text-gray" ><text style="color:red;margin-right:5px;">*</text>选择城市</view>
						<addressed @changes="childClick($event)" :isShow="false"></addressed>
				</view>


				<view class="cu-form-group">
						<view class="font-size-normal font-weight-normal color-normal text-gray"><text style="color:red;margin-right:5px;">*</text>详细地址</view>
						<input type="text" placeholder="详细地址" v-model="shop.address"  :class="shop.address?'text-black':'color-normal'" style="font-size:12px;text-align:right">
				</view>
		...
		<view style="margin-bottom:13px;">
			<view class="cu-form-group position_relative">
				<view class="font-size-normal font-weight-normal color-normal">开业日期</view>
				<view >
					<text   style="margin-right:20px;" class="font-size-normal" :class="shop.openDate?'text-black':'color-normal'" >{{shop.openDate}}</text>
					<text class="cuIcon-right color-normal position_absolute" style="font-size:20px;right:17px;bottom:11px;" @click="onShowDatePicker('date')"></text>
				</view>
			</view>

			<view class="cu-form-group">
				<view class="font-size-normal font-weight-normal color-normal">门店联系人</view>
				<text class="text-black text-left font-size-normal">{{shop.contractor}}</text>
				<!-- <input placeholder="门店联系人" v-model="shop.contractor" class="text-gray" style="font-size:12px;"></input> -->
			</view>
			<view class="cu-form-group position_relative">
				<view class="font-size-normal font-weight-normal color-normal">联系方式</view>
				<text class="text-black font-size-normal">{{shop.telephone}}</text>
			...
			<view class="cu-form-group">
				<view class="font-size-normal font-weight-normal color-normal">面积</view>
				<input type="text" placeholder="请输入面积" v-model="shop.area" :class="shop.area?'text-black':'color-normal'" style="font-size:12px;text-align:right">
			</view>
		</view>

		<view class="detail">
			<view class="font-size-normal font-weight-normal color-normal" style="margin-bottom:8px;">备注</view>
			<textarea v-model="shop.summary" placeholder="请输入备注"
			 :class="shop.summary?'color-normal':'text-black'"
			style="height:84px;background:rgba(247,247,247,1);padding-top:8px;padding-left:11px;width:100%;margin-bottom:14px;"/>
		<!-- 	<view class="cu-bar bg-white" style="border-top:1px solid rgba(238,238,237,1);">
			...
			<view class="text-center" style="margin-top:40rpx;">
				<button class="cu-btn block bg-blue  lg" @click="recordShop()" :disabled="loading">确定</button>
			</view>
		</view>
...
<script>
	...
	export default{
		...
		onLoad(){
			...
			this.getUploadToken();
			if(this.userInfo){
				this.shop.contractor=this.userInfo.name;
				this.shop.telephone=this.userInfo.account;
			}
