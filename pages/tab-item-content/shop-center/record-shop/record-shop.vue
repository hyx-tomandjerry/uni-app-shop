	...
	<view>
		<view  style="margin-bottom:13px;">
			<view class="text-gray text-sm">
				...
				<view class="cu-form-group">
						...
						<input type="text "  placeholder="门店名称" v-model="shop.name"  class="text-gray" style="font-size:12px;">
				</view>
				...
				<view class="cu-form-group">
						...
						<input type="text" placeholder="详细地址" v-model="shop.address"  class="text-gray" style="font-size:12px;">
				</view>
		...
		<view style="margin-bottom:13px;">
			<view class="cu-form-group">
				...
				<view @click="onShowDatePicker('date','open')">
			...
			<view class="cu-form-group">
				...
				<input type="text" placeholder="请输入面积" v-model="shop.area" class="text-gray" style="font-size:12px;">
			</view>
		</view>
...
// 			},
			...
			recordShop(){
				if(!this.category.id || !this.shop.name || !this.province.id || !this.shop.address){
					uni.showToast({
						title:'请填写完整信息',
						icon:'none'
					})
