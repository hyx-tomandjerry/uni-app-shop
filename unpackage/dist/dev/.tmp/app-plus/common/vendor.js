...
var store = new _vuex.default.Store({
  state: {
    ...
    uploadHostUrl: 'http://up.qiniup.com?f=',
    userInfo: null,
    statusHeight: 44,
    constants: {
      brand_type: 29, //品牌类别
