<template>
	<view class="operate-item flex justify-between align-center" 
	:class="{
		...
		<image :src="src"
		 :class="{
			 'apply_img':apply_img,
			 'check_img':check_img,
			 'sale_resolve_img':sale_resolve_img,
			 'sale_check_img':sale_check_img,
			 'express-item':express_item
		 }"
...
<script>
	export default {
		...
		props:{
			...
			name:String,
			value:String,
			sale_check_img:Boolean,
			sale_resolve_img:Boolean,
			apply_img:Boolean,
			check_img:Boolean,
...
.operate-item{
	...
	.border-Left-red{
		border-left:12upx solid #FF4C4C;
	}
	.border-left-y{
	...
	.border-left-g{
		border-left:12upx solid #15AFA1;
	}
	.express-item{
		width:90upx;
		height:90upx !important;
